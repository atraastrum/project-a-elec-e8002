...
""));
        ...
        sizePolicy.setHeightForWidth(ChoosingValve->sizePolicy().hasHeightForWidth());
        ChoosingValve->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(MotorSpeed->sizePolicy().hasHeightForWidth());
        MotorSpeed->setSizePolicy(sizePolicy);
